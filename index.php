                           ...
                           <div class="col-md-12 col-lg-7">
                              <div class="row">
                                 ...
                                 <div class="form-group">
                                    <form class="transfot" action="getquote.php" method="POST" >
                                       <div class="col-md-12">
                                       ...
                                       <div class="col-md-12">
                                          <input class="transfot_form" placeholder="Todestination" type="text" name="todestination">
                                       </div>
                                       <div class="col-md-12">
                                       ...
                                       <div class="col-md-12">
                                          <input class="transfot_form" placeholder="ContactNumber" type="text" name="contactnumber">
                                       </div>
                                      

                                       <div class="col-md-12">
                                          <button class name="submit" value="get_now" >Get Now quote</button>
                                       </div>
                                    </form>
                                 </div>
                              </div>
